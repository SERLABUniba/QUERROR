...
def main():
    ...
    run_test_scenario(mock_compiler_before, "Before fix - All gates allowed", qc, basis_gates={'h', 'x', 'cx'})
    ...
    run_test_scenario(mock_compiler_after, "After fix - All gates allowed", qc, basis_gates={'h', 'x', 'cx'})
