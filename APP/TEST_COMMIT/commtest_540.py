...
def compile_and_run(qfunc, x, y, z, fix_applied=False):
    ...
    if fix_applied:
        compiled_tapes, _ = qml.transforms.compile(tape, expand_depth=5)
    else:
...
def main():
    ...
    # Draw the circuit before compilation
    print("Original Circuit:\n", qml.draw(qfunc)(x, y, z))
    print("Results:", qfunc(x, y, z))

    print("\n=== Before Fix ===")
    compiled_tapes_before, results_before = compile_and_run(qfunc, x, y, z, fix_applied=False)
    # Draw the circuit after compilation
